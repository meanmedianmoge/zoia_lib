...
class TestSearching(unittest.TestCase):
    ...
    def test_search_edge_cases(self):
        ...
        self.assertTrue(util.search_patches(None, None) is None,
                        "Expected None but got data in return.")
        self.assertRaises(exc, util.search_patches, "Hi", "Yee")
        self.assertTrue(util.search_patches(None, "Hi") is None,
                        "Expected None but got data in return.")
        self.assertTrue(util.search_patches("", None) is None,
                        "Expected None but got data in return.")
    ...
    def test_title_search(self):
        ...
        self.assertTrue(result[0]["title"] == "LOVELESS",
                        "Expected to find the patch titled LOVELESS but "
                        "did not.")
        self.assertTrue(len(result) == 1, "Returned search result should have "
                                          "only contained 1 result.")
        ...
        self.assertTrue(result[0]["title"] == "Dream Bender",
                        "Expected to find the patch titled Dream Benders but "
                        "did not.")
        self.assertTrue(result[1]["title"] == "LOVELESS",
                        "Expected to find the patch titled loveless but "
                        "did not.")
        self.assertTrue(len(result) == 2, "Returned search result should have "
                                          "only contained 2 result.")
        ...
        self.assertTrue(result[0]["title"] == "Dream Bender",
                        "Expected to find the patch titled Dream Bender but "
                        "did not.")
        self.assertTrue(len(result) == 1, "Returned search result should have "
                                          "only contained 1 result.")
