...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sd_tree = QTreeView(self.tab_sd)
        ...
        self.sd_tree.setHeaderHidden(False)

        self.verticalLayout_8.addWidget(self.sd_tree)

        self.splitter_4 = QSplitter(self.tab_sd)
        self.splitter_4.setObjectName(u"splitter_4")
        self.splitter_4.setOrientation(Qt.Horizontal)
        self.splitter_4.setHandleWidth(10)
        self.table_3 = QTableWidget(self.splitter_4)
        if (self.table_3.columnCount() < 2):
        ...
        self.menubar.setGeometry(QRect(0, 0, 1662, 27))
